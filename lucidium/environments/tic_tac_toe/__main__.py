"""# lucidium.environments.tic_tac_toe.main

Tic-Tac-Toe environment main process entry point.
"""
...
def main(
    ...
    **kwargs
    ...
    # Initialize logger.
    _logger_:   Logger =    get_child(logger_name = "tic-tac-toe.main")
    ...
    except Exception as e:  _logger_.critical(f"Unexpected error caught in Tic-Tac-Toe main process: {e}", exc_info = True)